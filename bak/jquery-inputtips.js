            ...
            function getdata(obj, objd) {                                  //循环子元素，拼接datahtml
                ...
                function getsondata(obj) {                          //递归找子元素
                    obj.each(function () {
                        ...
                        if (objd.tagName == "OPTGROUP") {
                            if (objd.ht) {
                                objd.h += "<dt class='okchoose' title='" + objd.hte + "'>" + objd.hte + "</dt>"
                            } else {
                                objd.h += "<dt class='nochoose' title='" + objd.hte + "'>" + objd.hte + "</dt>"
                            }
                            ...
                            if (objd.ht) {
                                objd.h += "<dd class='nochoose' " + style + " data-val='" + objd.value + "' title='" + objd.hte + "'>" + objd.hte + "</dd>"
                            } else {
                                objd.h += "<dd class='okchoose' " + style + " data-val='" + objd.value + "' title='" + objd.hte + "'>" + objd.hte + "</dd>"
                            }
